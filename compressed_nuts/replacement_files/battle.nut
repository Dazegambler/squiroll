...
function Create(param){if(::replay.GetState()==::replay.PLAY)::discord.rpc_set_details("Watching a replay")
::discord.rpc_set_state("")
if(::replay.GetState()!=::replay.PLAY&&(::network.IsPlaying()||param.game_mode!=1))::discord.rpc_set_small_img_key(param.team[::network.IsPlaying()?(::network.is_parent_vs?1:0):0].master.name)
::discord.rpc_commit()
...
::manbow.CompileFile("data/script/battle/battle_param.nut",this)
::manbow.CompileFile("data/script/battle/battle_team.nut",this)
switch(param.game_mode){case 10: ::manbow.CompileFile("data/actor/status/gauge_story.nut",this.gauge)
...
inputdisplaysetup(1)
break
case 30: ::manbow.CompileFile("data/actor/status/gauge_vs.nut",this.gauge)
::manbow.CompileFile("data/script/battle/battle_tutorial.nut",this)
break
default: ::manbow.CompileFile("data/actor/status/gauge_vs.nut",this.gauge)
...
function Release(){if(this.ping_task!=null){::loop.DeleteTask(this.ping_task)
this.ping_task=null
this.ping_obj=null
}
