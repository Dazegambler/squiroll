if(!::setting.misc.hide_wip){this.item<-["story","tutorial","vs_com","vs_player","network","practice","replay","music","config","exit"]}else{this.item<-["story","vs_com","vs_player","network","practice","replay","music","config","exit"]}
this.proc<-{}
...
::sound.PlayBGM(::savedata.GetTitleBGMID())}else{this.Update<-this.UpdateOP
this.op.Initialize()}
::loop.Begin(this)}
...
::menu.title.Suspend()
::menu.character_select.Initialize(0,this.cursor_difficulty.val)}.bindenv(this))}}
