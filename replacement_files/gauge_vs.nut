function Initialize()
{
	...
	this.ping <- ::manbow.String();
	this.ping.Initialize(::talk.font);
	this.ping.Set("ping:0")
	this.ping.x = ::graphics.width/2;
	this.ping.y = -4;
	this.ping.text.ConnectRenderSlot(::graphics.slot.status,1000);
	this.ping.visible = ::network.IsActive();
