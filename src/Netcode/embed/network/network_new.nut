...
function UpdateInputAddr() {
	...
	if (::input_all.b0 == 1) {
        local addr = ::format(
            "%d.%d.%d.%d"
            , target_addr_v[0].val * 100 + target_addr_v[1].val * 10 + target_addr_v[2].val
            , target_addr_v[3].val * 100 + target_addr_v[4].val * 10 + target_addr_v[5].val
            , target_addr_v[6].val * 100 + target_addr_v[7].val * 10 + target_addr_v[8].val
            , target_addr_v[9].val * 100 + target_addr_v[10].val * 10 + target_addr_v[11].val
        );
       	local port = 0;
